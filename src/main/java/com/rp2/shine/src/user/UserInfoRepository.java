...
public interface UserInfoRepository extends JpaRepository<UsersInfo, Integer> {
    ...
    List<UsersInfo> findByPhoneNumber(String phoneNumber);
    List<UsersInfo> findByStatus(String status);
    List<UsersInfo> findByStatusAndNickname(String status, String word);
}