...
public enum BaseResponseStatus {
    ...
    FAILED_TO_POST_USEDSTORE(false, 3017, "중고거래 글 등록이 실패하였습니다."),
    FAILED_TO_DELETE_USEDSTORE(false, 3017, "중고거래 글 삭제가 실패하였습니다."),
    FAILED_TO_PATCH_USEDSTORE(false, 3018, "중고거래 글 삭제가 실패하였습니다."),
